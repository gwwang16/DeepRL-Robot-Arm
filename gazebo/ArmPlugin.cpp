		...
		*/
		...
		else
		{
			...
			if( episodeFrames > 1 )
			{
				...
				// printf("disGoal is %0.3f, distDelta is %0.3f, disPenalty is %0.3f\n", distGoal,distDelta,distPenalty);
				if(avgGoalDelta > 0)
				{
				...
				// rewardHistory = avgGoalDelta * 1.0f;  //-exp(gamma * distGoal);
				newReward     = true;
			}
